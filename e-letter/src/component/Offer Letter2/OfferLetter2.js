                ...
                <div class="card" id="pageA4">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <br />
                            <ol>
                                <li style={{ textAlign: 'justify' }}><u>APPOINTMENT:</u>
                                    <br />
                                    <br />
                                    <ol>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <ol style={{ paddingLeft: 70 }}>
                                <li style={{ textAlign: 'justify' }}>The Employee’s total compensation (Cost to the Company) shall be as per the above-mentioned schedule, payable in periodic installments according to the Company’s normal payroll practices, subject to standard deductions towards tax and other deductions as per Company policy.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>Performance reviews shall be done on a yearly basis with the first performance review at the end of twelve months. Salary increments shall be done on a yearly basis based on the performance of the Employee in that year which shall include professional efficiency, integrity, discipline, punctuality, professional grooming, Employee’s contribution towards profitability of the Company’s income, etc. The Employee’s increments are completely discretionary and will be subject to and on the basis of his effective performance and results during the period as also the performance and results of the Company. All or any such increment or bonus may be paid by the Company at the end of completion of every twelve months of employment.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>All statutory requirements of tax, including tax deductible at source, professional tax, etc, will be paid and complied by the Company and all/ any funds/ salary/ remuneration paid to the Employee will be after such appropriate deductions.</li>
                ...
                <div class="card" id="pageA4">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <p style={{ textAlign: 'justify' }}>The Employee will be entitled to avail holidays/ leaves as per the Company policies in force from time to time.</p>
                            <br />
                            <ol style={{ textAlign: 'justify' }} start={5}>
                                <li><u>NON – DISCLOSURE OF CONFIDENTIAL INFORMATION &amp; NON-COMPETE:</u></li>
                            </ol>
                            <ol style={{ paddingLeft: 70 }}>
                                <li style={{ textAlign: 'justify' }}>The Employee agrees that information concerning the working of the Company, including all the information concerning the Company’s business transactions, financial arrangements,</li>
                            </ol>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <ol style={{ paddingLeft: 70 }} start={2}>
                                ...
                                <li style={{ textAlign: 'justify' }}>Nothing contained in the previous/ above clause shall apply to:</li>
                                ...
                                <li style={{ textAlign: 'justify' }}>The Employee also agrees to promptly and without necessity of any demand, return to the Company, any and all documents, records, or writings made or obtained by the Employee in the course of his/her employment with the Company, on expiry or termination of this Agreement for any reason whatsoever.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee also agrees to sign on similar non- disclosure/ confidential agreement of any of the clients of the Company as and when required/ requested by the Company.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee agrees and undertakes not to take up employment with the existing clients of the Company during the subsistence of the Agreement without prior written consent of the Company.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee agrees and confirms that he/she will not accept any offer of employment from any customer, where he/she had worked during the course of employment with the Company for a continuous period of 6 months immediately preceding the termination of his/her employment in the Company.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee agrees and undertakes not to either directly or indirectly solicit the employees, customers, clients of the Company post termination of the his/her employment in the Company.</li>
                            </ol>
                            <br />
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <ol style={{ paddingLeft: 70 }} start={1}>
                                ...
                                <li style={{ textAlign: 'justify' }}>The Employee may pursue further education with the prior written consent of the Company. However, any such further education shall not in any way affect the work/ business of the Company.</li>
                            </ol>
                            <p style={{ textAlign: 'justify' }}>&nbsp;&nbsp;&nbsp;</p>
                            <ol style={{ textAlign: 'justify' }} start={7}>
                                <li><u>EMPLOYEE’S OBLIGATIONS:</u></li>
                            </ol>
                            <ol style={{ textAlign: 'justify', paddingLeft: 70 }} start={1}>
                                <li style={{ textAlign: 'justify' }}>The Employee agrees to carry out all the duties assigned by the Company with all due diligence and loyalty and keeping the Company’s interest paramount.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee agrees to not directly/ indirectly receive or accept for Employee’s own benefit any commission, rebate, discount or profit from any person/ firm/ company having business transactions with the Company.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>Employee agrees to supervise the work of Employee’s subordinates and shall always ensure proper and effective implementation and compliance of all the rules and regulations of the Company.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>The Employee shall not commit any illegal act/ breach of trust or bring any civil/ criminal or any such other liability on the Company. In any such event, the Employee alone will be liable for all such liabilities/ wrongs done.</li>

                                <br />

                                <li style={{ textAlign: 'justify' }}>During the term of this Agreement, the Employee agrees to be bound by the policies framed and enforced by the Company from time to time.</li>
                            </ol>
                            ...
                            <ol style={{ textAlign: 'justify', paddingLeft: 70 }}>
                                <li>The Employee for the purpose of the employment has provided the Company with the following documents and upload the Documents on the HR portal. This Is mandatory, contact HR team for further information</li>

                                <br />
                                <li style={{ textAlign: 'justify' }}>The Parties agree that the Company has offered employment to the Employee on the basis of the above mentioned documents and information provided by the Employee and on the understanding that there is nothing in the Employee’s past record which should have prevented in the Company from offering employment to the Employee under this Agreement. If any of the above documents/ information is found to be incorrect or false or in the opinion of the Company</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <ol style={{ textAlign: 'justify', paddingLeft: 70 }} start={3}>
                                ...
                                <li style={{ textAlign: 'justify' }}>If, for any reason, any provision of this Agreement is held invalid, all other provisions of this Agreement shall remain in full force and effect.</li>
                            </ol>
                            <br />
                            ...
                            <ol style={{ textAlign: 'justify', paddingLeft: 70 }}>
                                ...
                                <li>Subject to Clause 9.1, this Agreement shall be governed by the laws of India irrespective of conflict of law provisions and the Courts in Bengaluru shall have the exclusive jurisdiction to deal with the disputes arising out of this Agreement.</li>
                            </ol>
                            <br />
